...
#pragma warning(disable \
                : 4251)  // '...': class '...' needs to have dll-interface to be
...
#pragma warning(disable \
                : 6305)  // Potential mismatch between sizeof and countof
                         // quantities. Use sizeof() to scale byte sizes.
#pragma warning( \
        disable  \
        : 6389)  // Move '...' to anonymous namespace or put a forward
                 // declaration in a common header included in this file.
#pragma warning( \
        disable  \
        : 5267)  // definition of implicit copy constructor for '...' is
                 // deprecated because it has a user-provided destructor

#pragma warning(disable \
                : 26822)  // Dereferencing a null pointer '...' (lifetime.1).
#pragma warning(disable \
                : 26432)  // If you define or delete any default operation in
...
#pragma warning( \
        disable  \
        : 26485)  // Expression '...': No array to pointer decay (bounds.3).
...
#pragma warning( \
        disable  \
        : 26434)  // Function '...' hides a non-virtual function '...'.
#pragma warning(disable \
                : 26400)  // Do not assign the result of an allocation or a
...
#pragma warning( \
        disable  \
        : 26465)  // Don't use const_cast to cast away const or volatile.
                  // const_cast is not required; constness or volatility is not
                  // being removed by this conversion (type.3).
#pragma warning(disable \
                : 26408)  // Avoid malloc() and free(), prefer the nothrow
...
#pragma warning(disable \
                : 26461)  // The pointer argument '...' for function '...' can
                          // be marked as a pointer to const (con.3).
#pragma warning( \
        disable  \
        : 26436)  // The type '...' with a virtual function needs either public
...
#pragma warning( \
        ...
        : 26467)  // Converting from floating point to unsigned integral types
                  ...
                  // (es.46).
#pragma warning(disable \
                : 26135)  // Missing annotation _Acquires_lock_(this->mNative)
                          // at function '...'.
...
#pragma warning(disable : 26439)  // This kind of function should not throw.
                                  // Declare it '...' (f.6).
#pragma warning(disable \
                : 26454)  // Arithmetic overflow: '...' operation produces a
...
#pragma warning(disable : 26110)  // Caller failing to hold lock '...' before
                                  // calling function '...'.
#pragma warning(disable \
                : 26459)  // You called an STL function '...' with a raw pointer
...
#pragma warning(disable \
                : 26473)  // Don't cast between pointer types where the source
...
#pragma warning( \
        disable  \
        : 26489)  // Don't dereference a pointer that may be invalid: '...'.
