...
#pragma warning(disable : 4251)  // '...': class '...' needs to have dll-interface to be used by
                                 // clients of class '...'
...
#pragma warning(disable : 6305)  // Potential mismatch between sizeof and countof quantities. Use
                                 // sizeof() to scale byte sizes.
#pragma warning(disable : 6389)  // Move '...' to anonymous namespace or put a forward declaration
                                 // in a common header included in this file.
#pragma warning(disable : 5267)  // definition of implicit copy constructor for '...' is deprecated
                                 // because it has a user-provided destructor

#pragma warning(disable : 26822)  // Dereferencing a null pointer '...' (lifetime.1).
#pragma warning(disable : 26432)  // If you define or delete any default operation in the type
                                  // '...', define or delete them all (c.21).
#pragma warning(disable : 26429)  // Symbol '...' is never tested for nullness, it can be marked as
                                  // not_null (f.23).
...
#pragma warning(disable : 26447)  // The function is declared '...' but calls function '...' which
                                  // may throw exceptions (f.6).
#pragma warning(disable : 26496)  // The variable '...' does not change after construction, mark it
                                  // as const (con.4).
#pragma warning(disable : 26462)  // The value pointed to by '...' is assigned only once, mark it as
                                  // a pointer to const (con.4).
#pragma warning(disable : 26409)  // Avoid calling new and delete explicitly, use
...
#pragma warning(disable \
                : 26451)  // Arithmetic overflow: Using operator '...' on a 4 byte value and then
                          // casting the result to a 8 byte value. Cast the value to the wider type
                          // before calling operator '...' to avoid overflow (io.2).
#pragma warning( \
        disable  \
        : 26494)  // Variable '...' is uninitialized. Always initialize an object (type.5).
...
#pragma warning( \
        disable  \
        : 26435)  // Function '...' should specify exactly one of '...', '...', or '...' (c.128).
#pragma warning(disable : 26434)  // Function '...' hides a non-virtual function '...'.
#pragma warning(disable \
                : 26400)  // Do not assign the result of an allocation or a function call with an
                          // owner<T> return value to a raw pointer, use owner<T> instead (i.11).
...
#pragma warning(disable : 26465)  // Don't use const_cast to cast away const or volatile. const_cast
                                  // is not required; constness or volatility is not being removed
                                  // by this conversion (type.3).
...
#pragma warning(disable : 26460)  // The reference argument '...' for function '...' can be marked
                                  // as const (con.3).
#pragma warning(disable : 26495)  // Variable '...' is uninitialized. Always initialize a member
                                  // variable (type.6).
#pragma warning(disable : 26461)  // The pointer argument '...' for function '...' can be marked as
                                  // a pointer to const (con.3).
...
#pragma warning(disable \
                : 26135)  // Missing annotation _Acquires_lock_(this->mNative) at function '...'.
#pragma warning(disable : 28159)  // Consider using '...' instead of '...'. Reason: Deprecated. Use
...
#pragma warning(disable : 26454)  // Arithmetic overflow: '...' operation produces a negative
...
#pragma warning(disable \
                : 26110)  // Caller failing to hold lock '...' before calling function '...'.
#pragma warning(disable \
                : 26459)  // You called an STL function '...' with a raw pointer parameter at
                          // position '...' that may be unsafe - this relies on the caller to check
                          // that the passed values are correct. Consider wrapping your range in a
...
#pragma warning(disable \
                : 26486)  // Don't pass a pointer that may be invalid to a function. Parameter 0
                          // '...' in call to '...' may be invalid (lifetime.3).
...
#pragma warning(disable \
                : 26812)  // The enum type '...' is unscoped. Prefer '...' over '...' (Enum.3).
#pragma warning( \
        disable  \
