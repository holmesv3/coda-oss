...
#if _MSC_VER
#pragma warning(disable : 6313)  // Incorrect operator.  Use an equality test to check for
                                 // zero-valued flags.
#pragma warning(disable : 26493)  // Don't use C-style casts (type.4).
#pragma warning(disable : 26494)  // Variable '...' is uninitialized. Always initialize an object
                                  // (type.5).
...
#pragma warning(disable : 26435)  // Function '...' should specify exactly one of '...', '...', or
                                  // '...' (c.128).
#pragma warning(disable : 26433)  // Function '...' should be marked with '...' (c.128).
#pragma warning(disable : 26497)  // You can attempt to make '...' constexpr unless it contains any
...
#pragma warning(disable : 26457)  // (void) should not be used to ignore return values, use '...'
                                  // instead (es.48).
