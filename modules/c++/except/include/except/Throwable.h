...
#endif
#ifndef CODA_OSS_except_Throwable_ISA_std_exception  // or,
                                                     // -DCODA_OSS_except_Throwable_ISA_std_exception=1
