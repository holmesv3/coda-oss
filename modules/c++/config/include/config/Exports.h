...
// Need to specify how this code will be consumed, either CODA_OSS_LIB_ (static
// library) or CODA_OSS_DLL_ (aka "shared" library).  For DLLs, it needs to be
// set for BOTH "exporting" (building this code) and "importing" (consuming).
//
...
// CODA_OSS_EXPORTS symbol defined on the command line. This symbol should not
// be defined on any project that uses this DLL. This way any other project
// whose source files include this file see CODA_OSS_API functions as being
