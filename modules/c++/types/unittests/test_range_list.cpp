...
TEST_CASE(TestIntersection)
{
    ...
    const types::RangeList A(
            std::vector<types::Range>({{2, 5}, {10, 5}, {20, 10}, {31, 2}, {37, 1}, {45, 1}

            }));

    const types::RangeList B(
            std::vector<types::Range>({{1, 6}, {12, 2}, {22, 1}, {26, 3}, {30, 10}, {46, 1}}));
...
TEST_MAIN(TEST_CHECK(TestDisjointInsertion); TEST_CHECK(TestMergedInsertion);
