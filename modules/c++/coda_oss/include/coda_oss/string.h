...
#if CODA_OSS_cpp20
#if defined( \
        __cpp_lib_char8_t)  // https://en.cppreference.com/w/cpp/feature_test
...
#pragma warning(disable \
                : 5052)  // Keyword '...' was introduced in C++20 and requires
                         // use of the '...' command-line option
#endif

#if !defined(__cpp_char8_t)  // https://en.cppreference.com/w/cpp/feature_test
        enum class char8_t
    : unsigned char {};  // https://en.cppreference.com/w/cpp/language/types
...
using u8string = std::u8string;
        ...
        using u8string = std::basic_string<
                char8_t>;  // https://en.cppreference.com/w/cpp/string
#endif
