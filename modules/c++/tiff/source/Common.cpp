...
sys::Uint64_T tiff::combine(sys::Uint32_T numerator, sys::Uint32_T denominator)
{
    ...
    auto ptr = reinterpret_cast<sys::ubyte*>(&value);  // TODO: std::byte // reinterpret_cast<> to
                                                       // std::byte is allowed by the standard
...
void tiff::split(sys::Uint64_T value, sys::Uint32_T& numerator, sys::Uint32_T& denominator)
{
    ...
    auto ptr =
            reinterpret_cast<const sys::ubyte*>(&value);  // TODO: std::byte // reinterpret_cast<>
                                                          // to std::byte is allowed by the standard
