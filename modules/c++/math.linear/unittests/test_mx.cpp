...
TEST_CASE(testInvert2x2Complex)
{
    ...
    foreach_ij(2, 2)
    {
        TEST_ASSERT_ALMOST_EQ_EPS(std::abs(Qinv(i, j)),
                                  std::abs(C(i, j)),
                                  .0001);
    }
}
TEST_CASE(testInvert2x2)
{
    ...
    double q[] = {-0.326773864841957,
                  0.945102555946311,
                  0.945102555946311,
                  0.326773864841957};
    double correct[] = {-0.326773864841957,
                        0.945102555946311,
                        0.945102555946311,
                        0.326773864841957};
    Matrix2x2 Q(q);
...
TEST_CASE(testInvert3x3)
{
    ...
    double correct[] = {-0.833535710413543,
                        0.535408997517066,
                        -0.136218298488716,
                        -0.346676224975467,
                        -0.314923792289617,
...
TEST_CASE(testOrthoTranspose5x5)
{
    ...
    double q[] = {0.206598102328096,  -0.258732861775711, -0.366144101439697,
                  0.808267284061313,  0.320962653355259,  0.079760655075890,
                  0.923824193884886,  0.107508570320437,  0.351779072204311,
                  -0.069860492136368, -0.209804190945734, -0.239598615251375,
                  0.855978685620244,  0.398355064550789,  -0.084784652749218,
                  -0.755232695854446, -0.020059148734545, -0.347740376127862,
                  0.229811055794963,  -0.505454958536692, -0.580138982133012,
                  0.147635697417530,  0.027523169564286,  -0.107030850956001,
                  0.793365826298614};
...
TEST_CASE(testInvert5x5)
{
    ...
    double q[] = {-0.1, -0.0, 0.6,  -0.3, 0.6,  -0.2, 0.6, -0.1, 0.5,
                  0.4,  -0.9, 0.0,  0.0,  -0.2, -0.3, 0.3, 0.7,  -0.0,
                  -0.5, -0.1, -0.0, -0.2, -0.7, -0.3, 0.4};

    double correct[] = {-0.165907, -0.304698, -0.947308, 0.232976,  -0.098678,
...
TEST_MAIN(TEST_CHECK(testIdentityMxN); TEST_CHECK(testScaleMultiplyMxN);
