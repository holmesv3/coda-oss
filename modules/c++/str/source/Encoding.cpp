...
template <typename TChar>
static inline void w1252_to_basic_string(str::W1252string::const_pointer p,
                                         size_t sz,
...
static inline void w1252to16(str::W1252string::const_pointer p, size_t sz, std::u16string& result)
{
    ...
    const _bstr_t bstr(std::string(str::details::cast<const char*>(p), sz)
                               .c_str());  // no _bstr_t ctor taking sz
...
static void get_next_utf8_byte(coda_oss::u8string::const_pointer p,
                               size_t sz,
                               size_t& i,
                               coda_oss::u8string& utf8)
{
    if (!(i + 1 < sz))
    {
...
static void get_utf8_string(coda_oss::u8string::const_pointer p,
                            size_t sz,
                            size_t& i,
                            coda_oss::u8string& utf8)
{
...
template <typename TChar>
static inline void utf8to1252(coda_oss::u8string::const_pointer p,
                              size_t sz,
                              std::basic_string<TChar>& result)
{
