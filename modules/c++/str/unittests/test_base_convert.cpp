...
inline static void test_assert_eq(const std::string& testName,
                                  const std::u8string& actual,
...
static void test_string_to_u8string_windows_1252_(const std::string& testName,
...
static void test_change_case_(const std::string& testName,
                              const std::basic_string<TChar>& lower,
...
{
    return sys::Platform == sys::PlatformType::Linux
            ? toString(classificationText_u8())
...
static void test_wide_(const std::string& testName,
                       const char* pStr,
                       std::u16string::const_pointer pUtf16,
                       const std::wstring& wstring,
                       const std::string& native,
                       const str::W1252string& w1252)
{
...
static void test_Windows1252_ascii(const std::string& testName,
                                   const char* pStr,
                                   std::u16string::const_pointer pUtf16)
{
...
static void test_Windows1252_(const std::string& testName,
                              const char* pStr,
                              std::u16string::const_pointer pUtf16)
{
...
static void test_Encodeding_(const std::string& testName,
                             const coda_oss::u8string& classificationText_u8,
                             const std::string& utf_8,
                             const std::string& iso8859_1,
                             const coda_oss::u8string& utf_8_u8,
                             const coda_oss::u8string& iso8859_1_u8,
                             const std::string& utf_8_view,
