...
public:
    ...
    void doLines() override
    {
        //__warning__("Caesar, I never stood on ceremonies,   Yet now they
        // fright me. There is one within, 15  Besides the things that we have
        ...
        // yielded up their dead;   Fierce fiery warriors fought upon the clouds,
        // 20  In ranks and squadrons and right form of war,   Which drizzled
        // blood upon the Capitol;   The noise of battle hurtled in the air,
        // Horses did neigh, and dying men did groan,   And ghosts did shriek and
        // squeal about the streets. 25  O Caesar! these things are beyond all
...
public:
    ...
    void doLines() override
    {
        //__status__("Cowards die many times before their deaths;   The valiant
        // never taste of death but once. 35  Of all the wonders that I yet have
        // heard.   It seems to me most strange that men should fear;   Seeing
...
public:
    ...
    {
        //__status__("Be patient till the last.   Romans, countrymen, and
        // lovers! hear me for my 15  cause, and be silent, that you may hear:
        // believe me   for mine honour, and have respect to mine honour, that
        // you may believe: censure me in your wisdom, and   awake your senses,
        // that you may the better judge.   If there be any in this assembly, any
        // dear friend of 20  Caesar's, to him I say, that Brutus' love to Caesar
        ...
        // but that I loved   Rome more. Had you rather Caesar were living and 25
        ...
        // slew him. There is tears for his love; joy for his 30  fortune; honour
        // for his valour; and death for his   ambition. Who is here so base that
        // would be a   bondman? If any, speak; for him have I offended.   Who is
        // here so rude that would not be a Roman? If   any, speak; for him have
        // I offended. Who is here so 35  vile that will not love his country? If
...
public:
    ...
    void doLines() override
    {
        //__status__("Villains, you did not so, when your vile daggers   Hack'd
        // one another in the sides of Caesar:   You show'd your teeth like apes,
        // and fawn'd like hounds, 45  And bow'd like bondmen, kissing Caesar's
        // feet;   Whilst damned Casca, like a cur, behind   Struck Caesar on the
...
public:
    ...
    void doLines() override
    {
        //__status__("According to his virtue let us use him,   With all respect
        // and rites of burial.   Within my tent his bones to-night shall lie, 85
        // Most like a soldier, order'd honourably.   So call the field to rest;
...
int main(int, char**)
{
    try
    {
        ...
        //  	pool.addRequest(new ChangeRequest(new LogExHandler(new
        //  StandardOutStream())));
