...
struct Transform_par_settings final
{
    ...
    Transform_par_settings(std::launch policy, ptrdiff_t cutoff) :
        Transform_par_settings(cutoff, policy)
    {
    }
...
inline OutputIt Transform_par_(InputIt first1,
                               InputIt last1,
                               OutputIt d_first,
                               ...
                               const Transform_par_settings& settings)
{
    ...
    auto handle = std::async(settings.policy_,
                             Transform_par_<InputIt, OutputIt, UnaryOperation>,
                             mid1,
                             last1,
                             d_mid,
                             unary_op,
